    ...
    if args.path:
        ...
        for subject in subjects:
            ...
            for f in file_list:
                ...
                # print(all_chunks[0][0].shape)
                
                # print(len(all_chunks_2d))
                # print(len(all_chunks_2d[0]))
                # print(all_chunks_2d[0][0].shape)
                # print('===========================')
